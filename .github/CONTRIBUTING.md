...
- **Always try the [master branch](https://github.com/cozyphp/contracts)** - to see if the reported bug has not already been fixed.
...
We accept contributions via Pull Requests on [Github](https://github.com/cozyphp/contracts/pulls).

- **[PSR-12 Coding Standard](https://www.php-fig.org/psr/psr-12/)** - Your patch won't be accepted if it doesn't pass the package coding style test suite.
